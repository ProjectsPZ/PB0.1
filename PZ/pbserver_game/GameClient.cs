    ...
    private void RunPacket(byte[] buff, byte[] simple)
    {
      ...
      switch (uint16)
      {
        ...
        default:
          ...
          stringUtil.AppendLine("|[GC]| Opcode não encontrado " + (object) uint16);
          ...
          stringUtil.AppendLine("SessionId: " + (object) this.SessionId + "; SessionSeed: " + (object) this.SessionSeed + "; pId: " + (object) this.player_id);
