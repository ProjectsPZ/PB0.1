...
namespace Game.data.chat
{
  public static class CreateItem
  {
    public static string CreateItemYourself(string str, Account player)
    {
      ...
      player.SendPacket((SendPacket) new INVENTORY_ITEM_CREATE_PAK(1, player, new ItemsModel(id, itemCategory, "Command item", itemCategory == 3 ? 1 : 3, 1U, 0L)));
    ...
    public static string CreateItemByNick(string str, Account player)
    {
      ...
      account.SendPacket((SendPacket) new INVENTORY_ITEM_CREATE_PAK(1, account, new ItemsModel(int32, itemCategory, "Command item", itemCategory == 3 ? 1 : 3, 1U, 0L)), false);
