...
namespace Battle.data
{
  public class AllUtils
  {
    ...
    public static float GetDifferenceBetweenDate(DateTime date)
    {
...
label_24:
    ...
    public static ushort GetHitDamageUnk(uint info)
    {
      return (ushort) (info >> 21);
    }
    ...
    public static byte[] decrypt(byte[] data, int shift)
    {
      ...
      {
        Logger.warning(BitConverter.ToString(data), false);
        return new byte[0];
      }
    }
